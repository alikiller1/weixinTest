...
public class HttpRequest {
	...
	/**
	 * 向指定 URL 发送POST方法的请求,可以添加Cookie
	 * 
	 * @param url
	 *            发送请求的 URL
	 * @param param
	 *            请求参数，请求参数param应该是 name1=value1&name2=value2 的形式
	 *            请求参数cookieList应该是 cookieName=cookieValue 的形式
	 * @return 所代表远程资源的响应结果
	 */
	public static String sendPostAddCookie(String url, String param, List<String> cookieList) {
		PrintWriter out = null;
		BufferedReader in = null;
		String result = "";
		try {
